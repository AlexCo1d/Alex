...
Properties:
- if A is a symmetric matrix, then A is <u>positive semi-definite</u> iff all eigenvalues of A are <u>non-negative</u>
-  if A is a symmetric matrix, then A is <u>positive definite</u> iff all eigenvalues of A are <u>positive</u>
（二阶可导，则特征向量正/非负）
