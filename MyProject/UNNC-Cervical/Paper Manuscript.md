...
### 下采样
Enlightened by the work of #cite , we extensively adopt Convolutional Block Attention Module (CBAM) in our network, especially in Downsampling Stage. CBAM decouples the channel attention and spatial attention, dividing them into two independent submodules.
### Transformer
